                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($activity->bukti_file)
                                                            <x-button size="sm" variant="secondary" type="button" onclick="previewDocument('{{ \Illuminate\Support\Facades\Storage::disk('s3')->url($activity->bukti_file) }}', '{{ $activity->nama_aktivitas }}')">
